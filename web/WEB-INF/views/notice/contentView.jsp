                ...
                <td colspan="4" align="center">
                    ...
                    <c:if test="${loginUser ==  personalData.noticeWriterId}">
                        <input type="button" class="btn btn-outline-info" style="width: 20%;"
                               onclick="location.href='${contextPath }/notice/modify_form?noticeId=${personalData.noticeId }'"
                               value="수정">
                        <input type="button" class="btn btn-outline-danger" style="width: 20%;"
                               onclick="location.href='${contextPath }/notice/delete?noticeId=${personalData.noticeId }&noticeImageFileName=${personalData.noticeImageFileName}'"
                               value="삭제">
                    </c:if>
                    ...
                    <input type="button" class="btn btn-outline-success" style="width: 20%;"
                           onclick="location.href='${contextPath }/notice/noticeAllList'" value="목록"></td>
            </tr>
        </table>
    </div>
    <div id="modal_wrap">
